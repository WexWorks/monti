...
> **Archive:** This file contains the detailed tasks and verification for all completed phases from the [master implementation plan](monti_implementation_plan.md). See that file for active phases and future plans.
